					...
					<div class="card-body">
						...
						<form action="mModify" method="post" enctype="multipart/form-data">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="mName" value="${login.mName}">
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" id="sample6_postcode" placeholder="우편번호"
										class="form-control " name="addr1"> <input
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="email" class="form-control" name="mEmail" value="${login.mEmail}">
								</div>
							</div>
							<!-- 프로필사진 -->
							<div class="row mb-3">
...
<!-- 로그인 한 아디가 수정할 아이디와 일치하지 않으면 index로 이동 -->
